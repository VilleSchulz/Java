package t01;//Task 4: Cruise control Add to Car class a cruise control feature. With cruise control feature, the driver can set
...
public class Main_t01 {
    public static void main(String[] args) {
        Car_t01 myCar;
        myCar = new Car_t01("Toyota Corolla", 200, 100);
        myCar.fillTank();
        SuperCar mySuperCar;
        mySuperCar = new SuperCar("Toyota Corolla-S", 400, 100);
        for (int i = 0; i < 6; i++) {//start accelerating
            myCar.accelerate();
            mySuperCar.accelerate();
            System.out.println(myCar.getTypeName() + ": speed is " + myCar.getSpeed() + " km/h");

            System.out.println(mySuperCar.getTypeName() + ": speed is " + mySuperCar.getSpeed() + " km/h");
        }
